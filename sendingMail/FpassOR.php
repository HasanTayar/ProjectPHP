...
// Sender info 
$mail->setFrom('your_mail@gmail.com', 'WorldTours'); 
...
$bodyContent .= '<p>Hi , '.$row['Fname'].'.<br> Your Password For <b style="color:blue;">'.$row['Email'].'.</b><br> Hass Been Updated 
<br> Your New PassWord is: <br> <b style="color:red">'.$pass.'</b><br>
'; 
